...
# `datasets/composed/coco_basketball_105_22_23`.
#
...
# `object_ctrl.platforms.yolox` so the notebook stays readable.
...
DATASET_DIR = PROJECT_ROOT / "datasets" / "composed" / "coco_basketball_105_22_23"
